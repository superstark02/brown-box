                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-lg-2 col-md-4 col-12">
                                    {/*Logo Area Start*/}
                                    <div class="logo-area">
                                        <a href="index.html"><img src="https://demo.hasthemes.com/nelson-preview/nelson/assets/images/logo.png" alt="" /></a>
                                    </div>
                                    {/*Logo Area End*/}
                                </div>
                                            ...
                                            <li class="currency-menu"><a href="#"><i class="flaticon-user"></i></a>
                                                ...
                                                <ul class="currency-dropdown">
                                                    ...
                                                    <li><a href="#">language</a>
                                                        <ul>
                                                            <li class="active"><a href="#"><img src="./https://demo.hasthemes.com/nelson-preview/nelson/assets/images/icons/en-gb.png" alt="" />English</a></li>
                                                            <li><a href="#"><img src="./https://demo.hasthemes.com/nelson-preview/nelson/assets/images/icons/de-de.png" alt="" />French</a></li>
                                                        </ul>
                                                    </li>
                                                ...
                                                <div class="header-cart">
                                                    <ul class="cart-items">
                                                        <li class="single-cart-item">
                                                            <div class="cart-img">
                                                                <a href="cart.html"><img src="./https://demo.hasthemes.com/nelson-preview/nelson/assets/images/cart/cart1.jpg" alt="" /></a>
                                                            </div>
                                                        ...
                                                        <li class="single-cart-item">
                                                            <div class="cart-img">
                                                                <a href="cart.html"><img src="./https://demo.hasthemes.com/nelson-preview/nelson/assets/images/cart/cart2.jpg" alt="" /></a>
                                                            </div>
                                                            <div class="cart-content">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-6 col-md-6">
                                                <div class="header-logo">
                                                    <a href="index.html">
                                                        <img src="https://demo.hasthemes.com/nelson-preview/nelson/assets/images/logo.png" class="img-fluid" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-6">
