            ...
            <div>
                ...
                <div class="slider-area">
                    <div class="slider-active-2 ">
                        <div class="single-slider-4 bg-img furits-slider" style={{backgroundImage:"url(https://files.123freevectors.com/wp-content/original/150238-white-texture-background-image.jpg)"}} >
                            <div class="container">
                                <div class="fadeinup-animated furits-content text-center">
                                    ...
                                    <img class="animated slide-img-position" src="https://demo.hasthemes.com/ezone-preview/ezone-v1/assets/img/slider/11.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="testimonials-active owl-carousel">
                            <div class="fruits-single-testimonial text-center">
                                <img alt="" src="https://demo.hasthemes.com/ezone-preview/ezone-v1/assets/img/team/1.png" />
                                <h3>How such low rates?</h3>
                                <p>
                                    Know how we work and how you get products at such low rates
                                </p>
                                <p>
                                    <button>
                                        Know More
                ...
                <div class="newsletter-area bg-img ptb-105" style={{ backgroundImage: "url(https://demo.hasthemes.com/ezone-preview/ezone-v1/assets/img/banner/48.jpg)" }}>
                    <div class="container">
                        <div class="newsletter-wrapper">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-12">
                                    <div class="fruits-newsletter-title">
                                        <span>Pprovide Us Your</span>
                                        <h3>Feedback</h3>
                                    </div>
                                </div>
                                    ...
                                    <div id="mc_embed_signup" class="subscribe-form-furits f-right">
                                        <form action="http://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                            <div id="mc_embed_signup_scroll" class="mc-form">
                                                <input type="email" value="" name="EMAIL" class="email" placeholder="Write to us" required />
